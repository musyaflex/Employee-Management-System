public class Day implements Cloneable, Comparable<Day>{
	...
	// Take a day that was before this
	...
	// Get a day that will be after a certain 'period' from given 'startDay' 
	...
	// Get a day that was before given 'endDay' for a certain 'period' 
	...
	// Get period from startDay to endDay
	...
	// Check if the two DatesPair have an overlap
	...
	// Get overlap period of two DatesPair given
	...
	// Check if 'this' day is between given start and end days
